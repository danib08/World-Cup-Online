...
ADD CONSTRAINT PK_ScorerBet PRIMARY KEY(ID)

ALTER TABLE dbo.Assist_In_Bet
ADD CONSTRAINT PK_AssistBet PRIMARY KEY(ID)

ALTER TABLE dbo.Scorer_In_Match
ADD CONSTRAINT PK_ScorerMatch PRIMARY KEY(ID)

ALTER TABLE dbo.Assist_In_Match
ADD CONSTRAINT PK_AssistMatch PRIMARY KEY(ID)
